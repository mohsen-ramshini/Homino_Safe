...
export const MedicationsStep = ({ onContinue, onPrevious, setEhr, userEhr }: Props) => {
  ...
  const addMedication = () => {
    setMedications((prev) => [...prev, { name: "", dosage: "", frequency: "", notes: "", start_date: "" }]);
  };

const handleContinue = () => {
  const medicationsFormatted = medications.map((m) => ({
    ...m,
    start_date: m.start_date ? new Date(m.start_date).toISOString() : "",
  }));
